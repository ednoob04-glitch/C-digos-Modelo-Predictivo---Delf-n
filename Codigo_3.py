...
print("=== CELDA 3: INTELIGENCIA ARTIFICIAL A LARGO PLAZO (CORREGIDA) ===")

# =====================================================================
# 1. DEFINICIÓN DEL DESTINO FINAL SEGÚN ESTADOS UNIVERSITARIOS REALES
# =====================================================================
# Buscamos el último estado registrado de cada estudiante
...
# =====================================================================
# 2. DIVISIÓN ESTRATIFICADA 80/20 POR ALUMNO (Garantiza variedad de clases)
# =====================================================================
...
# =====================================================================
# 5. EVALUACIÓN Y GRÁFICA NARANJA
# =====================================================================
y_pred_lp = modelo_graduacion.predict(X_test_lp)

print(f"\nSISTEMA PREDICTIVO COMPLETADO")
...
plt.title('Matriz de Confusión: Predicción de Éxito a Largo Plazo', fontsize=12, pad=15)
